...
test <- profiles[sample(nrow(profiles), 59942), ]
...
training_model <- glm(is_female ~ income_level + job_new + body_type_buckets, data=training, family="binomial")

broom::tidy(training_model)

predict(training_model)

fitted(training_model)
